...
CONTAINS
    ...
    SUBROUTINE pbl_driver (&
        ...
        REAL(KIND = r8), INTENT(inout) :: qmtx   (ncols, kmax, 5 + nClass)         ! ToDo Denis check nAeros
        REAL(KIND = r8), INTENT(inout) :: umtx   (ncols, kmax, 4)
        REAL(KIND = r8), INTENT(in) :: tmsfc  (ncols, kmax, 3)
        REAL(KIND = r8), INTENT(in) :: qmsfc  (ncols, kmax, 5 + nClass)         ! ToDo Denis check nAeros
        ...
        REAL(KIND = r8), INTENT(inout) :: QSFC   (ncols)               ! ToDo Denis check DIMS !!!
        REAL(KIND = r8), INTENT(inout) :: TSK    (ncols)               ! ToDo Denis check DIMS !!!
        ...
        REAL(KIND = r8), INTENT(INOUT) :: pblh   (1:nCols)                            ! ToDo Denis check pblh parameter order !!!
        ...
        REAL(KIND = r8), OPTIONAL, INTENT(inout) :: gvar (ncols, kMax, nClass)      ! ToDo Denis check nAeros
