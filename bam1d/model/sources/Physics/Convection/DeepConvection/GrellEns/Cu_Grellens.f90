...
MODULE Cu_Grellens
 ...
 USE wv_saturation,Only : estblf,findsp_mask
 ...
 USE Diagnostics !, Only : nDiag_deepupm
  ...
  !----------------------------------------------------------------------------
!Enver (start)
!Enver  REAL(KIND=r8)   , PARAMETER :: detra = 10000.0_r8! detrainment value, original 12000. (10000-12000)
!Enver 
  REAL(KIND=r8)   , PARAMETER :: detra = 12000.0_r8! detrainment value, original 12000. (10000-12000)
!Enver (end)
...
CONTAINS
  ...
  SUBROUTINE RunCu_GrellEns(&
       ...
       cape   ,cine_LS,sens   ,cape_old, jdt)
...
250 END DO
  ...
  SUBROUTINE cup_env( &
    ...
    den=0.0_r8
   ! call findsp_mask (istart,iend,nCols,kMax, q, t, p*100_r8,ierr, tsp, qsp)
    DO k=1,kMax
       DO i=istart,iend
          IF(ierr(i) == 0)THEN
             !
...
!pk             xff_ens3(i,17)=MAX(den1(i,1)*0.25_r8*ee*cc,0.0_r8)  !Turbulence+cine impact
             !xff_ens3(i,17)=MAX(den1(i,1)*0.10_r8*ee*cc,0.0_r8)
             !xff_ens3(i,18)=MAX(den1(i,1)*0.10_r8*ee,0.0_r8)     !Turbulence+cine impact
             xff_ens3(i,17)=0.9_r8*MAX(dcape(i)/dtime,0.0_r8)
