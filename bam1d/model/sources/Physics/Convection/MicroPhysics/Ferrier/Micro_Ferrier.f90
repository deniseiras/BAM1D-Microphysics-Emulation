...
!    REAL(KIND=r8)   ,INTENT(INOUT) :: RAINNC     (1:nCols)
    ...
    do k=1, kMax
      ...
      call csv_write(9876, RHO(1,k), .false.)
      call csv_write(9876, gt(1,k), .false.)
      ...
      call csv_write(9876, F_ICE_PHY(1,k), .false.)
      call csv_write(9876, F_RAIN_PHY(1,k), .false.)
      call csv_write(9876, F_RIMEF_PHY(1,k), .false.)
      call csv_write(9876, pgr(1:1), .false.)
      call csv_write(9876, colrad(1:1), .true.)
    enddo
...
!
    ...
    do k=1, kMax
      ...
      call csv_write(8456, RHO(1,k), .false.)
      call csv_write(8456, gt(1,k), .false.)
      ...
      call csv_write(8456, F_ICE_PHY(1,k), .false.)
      call csv_write(8456, F_RAIN_PHY(1,k), .false.)
      call csv_write(8456, F_RIMEF_PHY(1,k), .false.)
      call csv_write(8456, RAINNCV(1:1), .false.)
      call csv_write(8456, SNOWNCV(1:1), .true.)
  end do
    !
    !-----------------------------------------------------------------------
